...
public class Product {
    ...
    public Product(String product_name, int unit_amount, double unit_price) {
        this.item_number = item_num++;
    ...
    public String toString() {
        ...
        return String.format("Item number: %d \nName of product: %s \nNumber of units in stock: %d \nPrice of each unit: $%.2f \n", item_number, product_name, unit_amount, unit_price);
    }
    

    //Method for calculating the vale of each inventory item usig quantity on hand and price 
    public double valueInventory(int unit_amount, double unit_price){
        double value = unit_amount * unit_price;
        return value;
    }
